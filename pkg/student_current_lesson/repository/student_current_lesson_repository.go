...
func (r *StudentCurrentLessonRepository) Create(studentCurrentLesson *models.StudentCurrentCourses) error {
	return r.db.Create(studentCurrentLesson).Error
}

func (r *StudentCurrentLessonRepository) Update(studentCurrentLesson *models.StudentCurrentCourses) error {
	return r.db.Save(studentCurrentLesson).Error
}

func (r *StudentCurrentLessonRepository) Delete(id uint) error {
	return r.db.Delete(&models.StudentCurrentCourses{}, id).Error
}

func (r *StudentCurrentLessonRepository) FindByID(id uint) (*models.StudentCurrentCourses, error) {
	var studentCurrentLesson models.StudentCurrentCourses
...
func (r *StudentCurrentLessonRepository) FindByTeacherID(teacherID uint) ([]*models.StudentCurrentCourses, error) {
	var studentCurrentLessons []*models.StudentCurrentCourses
...
func (r *StudentCurrentLessonRepository) FindByStudentID(studentID uint) ([]*models.StudentCurrentCourses, error) {
	var studentCurrentLessons []*models.StudentCurrentCourses
...
func (r *StudentCurrentLessonRepository) FindByTermID(termID uint) ([]*models.StudentCurrentCourses, error) {
	var studentCurrentLessons []*models.StudentCurrentCourses
...
func (r *StudentCurrentLessonRepository) FindByTeacherAndTerm(teacherID, termID uint) ([]*models.StudentCurrentCourses, error) {
	var studentCurrentLessons []*models.StudentCurrentCourses
...
func (r *StudentCurrentLessonRepository) FindByTeacherAndLesson(teacherID, lessonID uint) ([]*models.StudentCurrentCourses, error) {
	var studentCurrentLessons []*models.StudentCurrentCourses
...
func (r *StudentCurrentLessonRepository) GetTeacherSchedule(teacherID uint) ([]*models.StudentCurrentCourses, error) {
	var studentCurrentLessons []*models.StudentCurrentCourses
	err := r.db.Preload("Student").Preload("Lesson").Preload("Term").Preload("ClassTimes").
...
func (r *StudentCurrentLessonRepository) GetTeacherClassDetails(teacherID uint, lessonID uint) (*models.StudentCurrentCourses, error) {
	var studentCurrentLesson models.StudentCurrentCourses
	err := r.db.Preload("Student").Preload("Lesson").Preload("Term").Preload("ClassTimes").
